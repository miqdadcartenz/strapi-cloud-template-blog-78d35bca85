...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    homepage: Schema.Attribute.Relation<'manyToOne', 'api::homepage.homepage'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::article.article'
...
export interface ApiClientClient extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Klien (logo dan nama) untuk section beranda';
    displayName: 'Client';
    pluralName: 'clients';
    singularName: 'client';
  };
...
export interface ApiGalleryGallery extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Item galeri (gambar + caption) untuk section beranda';
    displayName: 'Gallery';
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    navbarLogo: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Konten halaman beranda company profile';
  ...
  attributes: {
    ...
    aboutStats: Schema.Attribute.Component<'home.stat-item', true>;
    artikelSection: Schema.Attribute.Component<'home.section-artikel', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    featuredProducts: Schema.Attribute.Relation<
      ...
      'api::product.product'
    >;
    galeriSection: Schema.Attribute.Component<'home.section-galeri', false>;
    heroSlides: Schema.Attribute.Component<'home.hero-slide', true>;
    klienSection: Schema.Attribute.Component<'home.section-klien', false>;
    klienStats: Schema.Attribute.Component<'home.stat-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    produkSection: Schema.Attribute.Component<'home.section-produk', false>;
    publishedAt: Schema.Attribute.DateTime;
    sertifikatSection: Schema.Attribute.Component<
      'home.section-sertifikat',
      false
    >;
    testimoniSection: Schema.Attribute.Component<
      'home.section-testimoni',
      true
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiProductPageProductPage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Konten halaman produk per slug (smartgov, efd, palapa, strategic-consulting)';
  ...
  attributes: {
    categories: Schema.Attribute.Component<'product-page.category', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Produk yang ditampilkan di beranda';
    displayName: 'Product';
    pluralName: 'products';
